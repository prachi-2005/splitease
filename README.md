...
🧮 Automatic equal expense splitting logic

🤝 Settlement functionality (Settle Up feature)
...
✨ Anti-gravity floating card animations
...
Expense balancing algorithm |
Modular file structure |
Responsive layout design |
CSS animation and UI effects
